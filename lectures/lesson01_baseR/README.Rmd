...
2. Create a new branch and switch to it `$ ` (`$ git checkout [name_of_your_new_branch]` to switch between branches)
...
```{r}
 ##it assigns the 20th index to that number 
```
